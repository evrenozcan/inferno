...
/**
 * The Class RandomDelayRectRenderer.
 * 
 * @author Evren Ozcan
 */
public class RandomDelayRectRenderer extends GenericDeltaProcessor
{
    ...
    /**
     * Instantiates a new random delay rect renderer.
     *
     ...
     */
    public RandomDelayRectRenderer(final int count, final int relativeX, final int relativeY, final int areaWidth,
